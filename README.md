## jsk_recognition (noetic) - 1.2.19-1

The packages in the `jsk_recognition` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -y --skip-pip jsk_recognition --track noetic --rosdistro noetic` on `Wed, 14 May 2025 06:51:45 -0000`
...
## jsk_recognition (noetic) - 1.2.18-1

The packages in the `jsk_recognition` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --skip-pip jsk_recognition --track noetic --rosdistro noetic` on `Sat, 10 May 2025 06:46:45 -0000`
...
## jsk_recognition (noetic) - 1.2.17-2
...
The packages in the `jsk_recognition` repository were released into the `melodic` distro by running `/usr/bin/bloom-release jsk_recognition --track melodic --rosdistro melodic --skip-pip` on `Fri, 10 Nov 2023 08:56:37 -0000`
...
The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 18 Jan 2016 12:28:17 -0000`
...
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.3.8-1`
- old version: `0.3.13-6`
- new version: `0.3.13-7`
...
## jsk_recognition (jade) - 0.3.13-6

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 11 Jan 2016 12:28:13 -0000`
...
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.3.8-1`
- old version: `0.3.13-5`
- new version: `0.3.13-6`
...
## jsk_recognition (jade) - 0.3.13-5

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 04 Jan 2016 12:28:40 -0000`
...
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.3.8-1`
- old version: `0.3.13-4`
- new version: `0.3.13-5`
...
## jsk_recognition (jade) - 0.3.13-4

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 28 Dec 2015 12:29:11 -0000`
...
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.3.8-1`
- old version: `0.3.13-3`
- new version: `0.3.13-4`
...
## jsk_recognition (jade) - 0.3.13-3

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 21 Dec 2015 12:28:17 -0000`
...
## jsk_recognition (jade) - 0.3.13-2

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 20 Dec 2015 05:10:53 -0000`
...
## jsk_recognition (indigo) - 0.3.13-1

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 20 Dec 2015 04:59:07 -0000`
...
## jsk_recognition (indigo) - 0.3.13-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 20 Dec 2015 03:31:19 -0000`
...
## jsk_recognition (jade) - 0.3.11-0

The packages in the `jsk_recognition` repository were released into the `jade` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 17 Dec 2015 18:13:57 -0000`
...
## jsk_recognition (indigo) - 0.3.11-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 17 Dec 2015 18:02:52 -0000`
...
## jsk_recognition (indigo) - 0.3.10-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 17 Dec 2015 06:01:32 -0000`
...
## jsk_recognition (indigo) - 0.3.6-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 11 Sep 2015 08:37:34 -0000`
...
## jsk_recognition (hydro) - 0.3.6-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 11 Sep 2015 08:26:43 -0000`
...
## jsk_recognition (indigo) - 0.3.5-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 08 Sep 2015 18:36:15 -0000`
...
## jsk_recognition (hydro) - 0.3.5-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 08 Sep 2015 18:26:23 -0000`
...
## jsk_recognition (indigo) - 0.3.4-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 07 Sep 2015 04:04:29 -0000`
...
## jsk_recognition (hydro) - 0.3.4-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 07 Sep 2015 03:53:54 -0000`
...
## jsk_recognition (indigo) - 0.3.3-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 06 Sep 2015 06:37:57 -0000`
...
## jsk_recognition (hydro) - 0.3.3-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 06 Sep 2015 06:27:19 -0000`
...
## jsk_recognition (indigo) - 0.3.2-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 05 Sep 2015 04:04:04 -0000`
...
## jsk_recognition (hydro) - 0.3.2-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 05 Sep 2015 03:53:38 -0000`
...
## jsk_recognition (indigo) - 0.3.1-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 04 Sep 2015 08:32:32 -0000`
...
## jsk_recognition (hydro) - 0.3.1-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 04 Sep 2015 08:22:23 -0000`
...
## jsk_recognition (indigo) - 0.3.0-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 04 Sep 2015 04:40:18 -0000`
...
## jsk_recognition (hydro) - 0.3.0-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 04 Sep 2015 04:26:44 -0000`
...
## jsk_recognition (indigo) - 0.2.18-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 03 Sep 2015 16:36:15 -0000`
...
## jsk_recognition (hydro) - 0.2.18-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 03 Sep 2015 16:26:14 -0000`
...
## jsk_recognition (indigo) - 0.2.17-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 20 Aug 2015 18:35:30 -0000`
...
## jsk_recognition (hydro) - 0.2.17-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 20 Aug 2015 18:26:41 -0000`
...
## jsk_recognition (indigo) - 0.2.16-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 19 Aug 2015 14:10:15 -0000`
...
## jsk_recognition (hydro) - 0.2.16-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 19 Aug 2015 14:00:55 -0000`
...
## jsk_recognition (indigo) - 0.2.15-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 18 Aug 2015 10:35:01 -0000`
...
## jsk_recognition (hydro) - 0.2.15-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 18 Aug 2015 10:26:23 -0000`
...
## jsk_recognition (indigo) - 0.2.14-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 14 Aug 2015 08:17:07 -0000`
...
## jsk_recognition (hydro) - 0.2.14-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 14 Aug 2015 08:08:19 -0000`
...
## jsk_recognition (indigo) - 0.2.13-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 19 Jun 2015 04:35:23 -0000`
...
## jsk_recognition (hydro) - 0.2.13-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 19 Jun 2015 04:26:39 -0000`
...
## jsk_recognition (indigo) - 0.2.12-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 04 May 2015 03:37:29 -0000`
...
## jsk_recognition (hydro) - 0.2.12-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 04 May 2015 03:27:48 -0000`
...
## jsk_recognition (indigo) - 0.2.11-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 13 Apr 2015 08:35:14 -0000`
...
## jsk_recognition (hydro) - 0.2.11-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 13 Apr 2015 08:25:59 -0000`
...
## jsk_recognition (indigo) - 0.2.10-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 09 Apr 2015 03:09:34 -0000`
...
## jsk_recognition (hydro) - 0.2.10-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 09 Apr 2015 02:40:14 -0000`
...
## jsk_recognition (indigo) - 0.2.9-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 01 Apr 2015 14:36:09 -0000`
...
## jsk_recognition (hydro) - 0.2.9-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 01 Apr 2015 14:25:36 -0000`
...
## jsk_recognition (indigo) - 0.2.7-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 25 Mar 2015 18:32:56 -0000`
...
## jsk_recognition (hydro) - 0.2.7-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 25 Mar 2015 18:24:33 -0000`
...
## jsk_recognition (indigo) - 0.2.6-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 25 Mar 2015 12:33:28 -0000`
...
## jsk_recognition (hydro) - 0.2.6-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 25 Mar 2015 12:24:41 -0000`
...
## jsk_recognition (indigo) - 0.2.5-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 17 Mar 2015 08:33:12 -0000`
...
## jsk_recognition (hydro) - 0.2.5-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 17 Mar 2015 08:24:54 -0000`
...
## jsk_recognition (indigo) - 0.2.4-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 09 Mar 2015 02:50:18 -0000`
...
## jsk_recognition (hydro) - 0.2.4-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 09 Mar 2015 02:37:43 -0000`
...
## jsk_recognition (indigo) - 0.2.3-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 01 Feb 2015 18:42:17 -0000`
...
## jsk_recognition (hydro) - 0.2.3-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 01 Feb 2015 18:24:51 -0000`
...
## jsk_recognition (indigo) - 0.2.2-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 30 Jan 2015 10:45:21 -0000`
...
## jsk_recognition (hydro) - 0.2.2-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 30 Jan 2015 10:36:51 -0000`
...
## jsk_recognition (indigo) - 0.2.1-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 Jan 2015 16:32:55 -0000`
...
## jsk_recognition (hydro) - 0.2.1-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 Jan 2015 16:24:28 -0000`
...
## jsk_recognition (hydro) - 0.2.0-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/usr/bin/bloom-release jsk_recognition --track hydro --rosdistro hydro` on `Thu, 29 Jan 2015 04:16:34 -0000`
...
- upstream repository: https://github.com/jsk-ros-pkg/jsk_recognition
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.1.33-0`
- old version: `0.1.33-0`
- new version: `0.2.0-0`
...
## jsk_recognition (indigo) - 0.2.0-0

The packages in the `jsk_recognition` repository were released into the `indigo` distro by running `/usr/bin/bloom-release jsk_recognition --track indigo --rosdistro indigo --new-track` on `Thu, 29 Jan 2015 03:30:10 -0000`
...
## jsk_recognition (hydro) - 0.1.33-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 24 Jan 2015 13:38:24 -0000`
...
- upstream repository: https://github.com/jsk-ros-pkg/jsk_recognition
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.1.32-0`
- old version: `0.1.32-0`
- new version: `0.1.33-0`
...
## jsk_recognition (hydro) - 0.1.32-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 12 Jan 2015 14:23:57 -0000`
...
- upstream repository: https://github.com/jsk-ros-pkg/jsk_recognition
- release repository: https://github.com/tork-a/jsk_recognition-release.git
- rosdistro version: `0.1.31-0`
- old version: `0.1.31-0`
...
## jsk_recognition (hydro) - 0.1.31-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 08 Jan 2015 06:23:41 -0000`
...
## jsk_recognition (hydro) - 0.1.30-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 24 Dec 2014 09:29:32 -0000`
...
## jsk_recognition (hydro) - 0.1.29-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 24 Dec 2014 06:04:51 -0000`
...
## jsk_recognition (hydro) - 0.1.28-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 21 Dec 2014 12:43:11 -0000`
...
## jsk_recognition (hydro) - 0.1.27-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 09 Dec 2014 13:49:50 -0000`
...
## jsk_recognition (hydro) - 0.1.26-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 23 Nov 2014 07:23:12 -0000`
...
## jsk_recognition (hydro) - 0.1.25-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 22 Nov 2014 02:09:29 -0000`
...
## jsk_recognition (hydro) - 0.1.23-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 09 Oct 2014 07:22:10 -0000`
...
## jsk_recognition (hydro) - 0.1.22-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 23 Sep 2014 17:23:24 -0000`
...
## jsk_recognition (groovy) - 0.1.21-1

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 20 Sep 2014 15:25:58 -0000`
...
## jsk_recognition (hydro) - 0.1.21-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 20 Sep 2014 13:33:35 -0000`
...
## jsk_recognition (groovy) - 0.1.21-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 20 Sep 2014 13:27:56 -0000`
...
## jsk_recognition (hydro) - 0.1.20-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 17 Sep 2014 09:28:44 -0000`
...
## jsk_recognition (groovy) - 0.1.20-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Wed, 17 Sep 2014 09:23:09 -0000`
...
## jsk_recognition (hydro) - 0.1.19-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 16 Sep 2014 04:01:46 -0000`
...
## jsk_recognition (groovy) - 0.1.19-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `./send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 16 Sep 2014 03:56:07 -0000`
...
## jsk_recognition (hydro) - 0.1.18-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 12 Sep 2014 18:08:04 -0000`
...
## jsk_recognition (groovy) - 0.1.18-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 12 Sep 2014 18:02:32 -0000`
...
## jsk_recognition (hydro) - 0.1.17-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 07 Sep 2014 09:19:11 -0000`
...
## jsk_recognition (groovy) - 0.1.17-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 07 Sep 2014 09:13:37 -0000`
...
## jsk_recognition (hydro) - 0.1.16-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 04 Sep 2014 03:28:44 -0000`
...
## jsk_recognition (groovy) - 0.1.16-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 04 Sep 2014 03:23:09 -0000`
...
## jsk_recognition (hydro) - 0.1.14-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 01 Aug 2014 06:53:06 -0000`
...
## jsk_recognition (groovy) - 0.1.14-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Fri, 01 Aug 2014 06:47:51 -0000`
...
## jsk_recognition (hydro) - 0.1.13-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 29 Jul 2014 03:16:42 -0000`
...
## jsk_recognition (groovy) - 0.1.13-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 29 Jul 2014 02:39:12 -0000`
...
## jsk_recognition (hydro) - 0.1.12-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 24 Jul 2014 04:15:39 -0000`
...
## jsk_recognition (groovy) - 0.1.12-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 24 Jul 2014 03:15:40 -0000`
...
## jsk_recognition (hydro) - 0.1.11-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 08 Jul 2014 09:27:42 -0000`
...
## jsk_recognition (groovy) - 0.1.11-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 08 Jul 2014 09:22:32 -0000`
...
## jsk_recognition (groovy) - 0.1.10-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Mon, 07 Jul 2014 15:22:39 -0000`
...
## jsk_recognition (hydro) - 0.1.9-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 01 Jul 2014 07:27:34 -0000`
...
## jsk_recognition (groovy) - 0.1.9-1

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Tue, 01 Jul 2014 07:22:31 -0000`
...
## jsk_recognition (hydro) - 0.1.8-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sun, 29 Jun 2014 11:22:42 -0000`
...
## jsk_recognition (groovy) - 0.1.8-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/usr/bin/bloom-release --rosdistro groovy --track groovy jsk_recognition` on `Sun, 29 Jun 2014 08:09:16 -0000`
...
## jsk_recognition (hydro) - 0.1.7-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 31 May 2014 07:27:47 -0000`
...
## jsk_recognition (groovy) - 0.1.7-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Sat, 31 May 2014 07:22:32 -0000`
...
## jsk_recognition (hydro) - 0.1.6-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 May 2014 15:27:51 -0000`
...
## jsk_recognition (groovy) - 0.1.6-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 May 2014 15:22:33 -0000`
...
## jsk_recognition (hydro) - 0.1.5-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 May 2014 01:56:01 -0000`
...
## jsk_recognition (groovy) - 0.1.5-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/var/lib/jenkins/send_to_bloom.py jsk-ros-pkg jsk_recognition` on `Thu, 29 May 2014 01:50:44 -0000`
...
## jsk_recognition (groovy) - 0.1.4-0

The packages in the `jsk_recognition` repository were released into the `groovy` distro by running `/usr/bin/bloom-release jsk_recognition --rosdistro groovy --track groovy` on `Fri, 25 Apr 2014 05:56:26 -0000`
...
## jsk_recognition (hydro) - 0.1.4-0

The packages in the `jsk_recognition` repository were released into the `hydro` distro by running `/usr/bin/bloom-release jsk_recognition --rosdistro hydro --track hydro` on `Fri, 25 Apr 2014 05:53:06 -0000`
...
## jsk_recognition (groovy) - 0.1.3-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `groovy` distro by running `/usr/bin/bloom-release jsk_recognition --track groovy --rosdistro groovy` on `Sat, 12 Apr 2014 12:54:04 -0000`
...
## jsk_recognition (hydro) - 0.1.3-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `hydro` distro by running `/usr/bin/bloom-release jsk_recognition --track hydro --rosdistro hydro` on `Sat, 12 Apr 2014 12:34:45 -0000`
...
## jsk_recognition (groovy) - 0.1.2-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `groovy` distro by running `/usr/bin/bloom-release jsk_recognition --track groovy --rosdistro groovy` on `Fri, 11 Apr 2014 06:19:53 -0000`
...
## jsk_recognition (hydro) - 0.1.2-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `hydro` distro by running `/usr/bin/bloom-release jsk_recognition --track hydro --rosdistro hydro` on `Fri, 11 Apr 2014 05:47:25 -0000`
...
## jsk_recognition (groovy) - 0.1.1-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `groovy` distro by running `/usr/bin/bloom-release --rosdistro groovy --track groovy jsk_recognition --edit` on `Wed, 09 Apr 2014 16:52:15 -0000`
...
## jsk_recognition (hydro) - 0.1.1-0

User `k-okada@kokada-t430s` released the packages in the `jsk_recognition` repository into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro jsk_recognition --edit` on `Wed, 09 Apr 2014 16:45:54 -0000`
